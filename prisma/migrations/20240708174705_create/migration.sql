...
CREATE TABLE "order_eventss" (
    ...
    CONSTRAINT "order_eventss_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "order_eventss" ADD CONSTRAINT "order_eventss_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "orders"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
